	...
	testCases := map[string]struct {
		...
		"overwrite": {
			env: map[string]string{
				...
				"K6_CLICKHOUSE_ORG_ID":        "00000000-0000-0000-0000-000000000001",
				"K6_CLICKHOUSE_ACCOUNT_ID":    "00000000-0000-0000-0000-000000000002",
				"K6_CLICKHOUSE_REGION":        "asia-south1",
				"K6_CLICKHOUSE_RUN_ID":        "00000000-0000-0000-0000-000000000003",
